...
public class RestClient {
     ...
     * @throws RestClientException .
     */
    public InstallServiceResponse installService(final String applicationName, final String serviceName, final InstallServiceRequest request)
            throws RestClientException {
     ...
     * @throws RestClientException .
     */
    public InstallApplicationResponse installApplication(final String applicationName, final InstallApplicationRequest request) throws RestClientException {
     ...
     */
    public UninstallServiceResponse uninstallService(final String applicationName, final String serviceName, final int timeoutInMinutes)
            throws RestClientException {
     ...
     *             Indicates the uninstall operation failed.
     */
    public UninstallApplicationResponse uninstallApplication(final String applicationName, final int timeoutInMinutes) throws RestClientException {
     ...
     * @throws RestClientException .
     */
    public DeploymentEvents getDeploymentEvents(final String deploymentId, final int from, final int to) throws RestClientException {
        validateDeploymentID(deploymentId, "getDeploymentEvents(String,int,int)");
        final String url = getFormattedUrl(versionedDeploymentControllerUrl, GET_DEPLOYMENT_EVENTS_URL_FORMAT, deploymentId, String.valueOf(from),
                String.valueOf(to));
    ...
    private void validateDeploymentID(final String deploymentId, final String methodName) throws RestClientException {
        if (deploymentId == null) {
            ...
            throw MessagesUtils.createRestClientException(CloudifyErrorMessages.MISSING_DEPLOYMENT_ID.getName(), methodName);
        }
    }
     ...
     * @throws RestClientException .
     */
    public ServiceDescription getServiceDescription(final String appName, final String serviceName) throws RestClientException {
     ...
     * @throws RestClientException
     */
    public List<ServiceDescription> getServiceDescriptions(final String deploymentId) throws RestClientException {
     ...
     *             in case of an error.
     */
    public void setServiceInstances(final String applicationName, final String serviceName, final SetServiceInstancesRequest request)
            throws RestClientException {
        if (request == null) {
     ...
     */
    public InvokeServiceCommandResponse invokeServiceCommand(final String applicationName, final String serviceName, final InvokeCustomCommandRequest request)
            throws RestClientException {
     ...
     *             when the invocation failed or the service/instance were not found.
     */
    public InvokeInstanceCommandResponse invokeInstanceCommand(final String applicationName, final String serviceName, final int instanceId,
        ...
        final String invokeCommandUrl = getFormattedUrl(versionedDeploymentControllerUrl, INVOKE_INSTANCE_COMMAND_URL_FORMAT, applicationName, serviceName,
                instanceIdStr);
    ...
    protected void validateFile(final File file) throws RestClientException {
        ...
        if (length > CloudifyConstants.DEFAULT_UPLOAD_SIZE_LIMIT_BYTES) {
            throw MessagesUtils.createRestClientException(RestClientMessageKeys.UPLOAD_FILE_SIZE_LIMIT_EXCEEDED.getName(), absolutePath, length,
     ...
     * @throws RestClientException .
     */
    public GetTemplateResponse getTemplate(final String templateName) throws RestClientException {
     ...
     * @throws RestClientException .
     */
    public AddTemplatesResponse addTemplates(final AddTemplatesRequest request) throws RestClientException, AddTemplatesException {
        ...
        try {
            ...
            try {
                ...
                log(Level.FINE, "[addTemplates] - caught JsonProcessingException " + "when tried to read the response from the verbose, "
                        + " throwing the RestClientException that constructed " + "from the original exception");
                throw e;
            } catch (final IOException e1) {
                // failed to read the response from the verbose => not a partial failure
                // => throwing the original exception
                if (logger.isLoggable(Level.FINE)) {
                    logger.log(Level.FINE, "[addTemplates] - caught IOException " + "when tried to read the response from the verbose, "
                            + " throwing the RestClientException that constructed " + "from the original exception", e1);
                }
                throw e;
            }
        }
     ...
     * @throws RestClientException .
     */
    public void removeTemplate(final String templateName) throws RestClientException {
     ...
     * @throws RestClientException
     */
    public GetPUDumpFileResponse getPUDumpFile(final long fileSizeLimit) throws RestClientException {
     ...
     * @throws RestClientException
     */
    public GetMachineDumpFileResponse getMachineDumpFile(final String ip, final long fileSizeLimit, final String processors) throws RestClientException {
        if (ip == null) {
        ...
        final String getMachineDumpFileURL = getFormattedUrl(shutdownManagersControllerUrl, GET_MACHINE_DUMP_FILE_URL_FORMAT, ip, actualProcessors,
     ...
     * @throws RestClientException
     */
    public GetMachinesDumpFileResponse getMachinesDumpFile(final String processors, final long fileSizeLimit) throws RestClientException {
        ...
        final String getMachinesDumpFileURL = getFormattedUrl(shutdownManagersControllerUrl, GET_MACHINES_DUMP_FILE_URL_FORMAT, actualProcessors,
                Long.toString(actualSizeLimit));
    ...
    public int getSocketTimeout() {
        ...
        if (StringUtils.isNotBlank(restClientSocketTimeoutSysProp)) {
            try {
                ...
                logger.severe("Failed to parse integer system property: " + CloudifyConstants.SYSTEM_PROPERTY_REST_CLIENT_SOCKET_TIMEOUT_MILLIS
                        + ". Value was: " + restClientSocketTimeoutSysProp + ". Using default value " + CloudifyConstants.DEFAULT_HTTP_READ_TIMEOUT
                        + " instead");
            }
        } else {
