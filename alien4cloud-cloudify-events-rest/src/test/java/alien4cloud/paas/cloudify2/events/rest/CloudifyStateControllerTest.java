package alien4cloud.paas.cloudify2.events.rest;
...
import alien4cloud.paas.cloudify2.events.EventType;
...
public class CloudifyStateControllerTest {
    ...
    public void testPutEvent() throws Exception {
        ...
        this.doTestGetEvents(APPLI_NAME, SERVICE_NAME, INSTANCE_ID, 0,
                Arrays.asList("PRE_SERVICE_START", "PRE_INSTALL", "INSTALL", "POST_INSTALL", "PRE_START", "START"));
        ...
        this.doTestGetEvents(newApplication, SERVICE_NAME, INSTANCE_ID, 0, Arrays.asList("PRE_SERVICE_START", "PRE_INSTALL"));
        ...
        this.doTestGetEvents(APPLI_NAME, newService, INSTANCE_ID, 0, Arrays.asList("PRE_SERVICE_START", "PRE_INSTALL"));
        ...
        this.doTestGetEvents(APPLI_NAME, SERVICE_NAME, "2", 0, Arrays.asList("PRE_SERVICE_START", "PRE_INSTALL"));
    }
    ...
    public void testPostEvent() throws Exception {
        ...
        this.doTestGetEvents(APPLI_NAME, SERVICE_NAME, INSTANCE_ID, 0,
                Arrays.asList("PRE_SERVICE_START", "PRE_INSTALL", "INSTALL", "POST_INSTALL", "PRE_START", "START", "FORMATING"));
        ...
        this.doTestGetEvents(newApplication, SERVICE_NAME, INSTANCE_ID, 0, Arrays.asList("PRE_INSTALL", "FORMATING"));
        ...
        this.doTestGetEvents(APPLI_NAME, newService, INSTANCE_ID, 0, Arrays.asList("PRE_SERVICE_START", "FORMATING"));
        ...
        this.doTestGetEvents(APPLI_NAME, SERVICE_NAME, "2", 0, Arrays.asList("PRE_SERVICE_START", "FORMATING"));
